...
const translations: Record<string, Record<string, string>> = {
    en: {
        ...
        'mobile_app_subtitle': 'Take your job search with you. Access thousands of job listings, apply in real-time, and receive notifications for opportunities that match your profile.',
        'download_for_android': 'Download for Android',
        'version_free': 'Version 1.0.0 • Free',
        'download_apk': 'Download APK (74.5 MB)',
        'or': 'or',
        'show_qr_code': 'Show QR Code',
        'hide_qr_code': 'Hide QR Code',
        'scan_with_android': 'Scan with your Android device',
        'point_camera_qr': 'Point your camera at the QR code to download directly',
        'important_enable_unknown_sources': '⚠️ Important: Enable unknown sources',
        'install_app_instructions': 'To install this app from outside Google Play Store, you need to:',
        'step_1_settings': 'Go to Settings on your device',
        'step_2_security': 'Look for Security or Privacy',
        'step_3_enable': 'Enable Unknown sources or Install unknown apps',
        'step_4_browser': 'Allow installation from browser',
        'app_safe_notice': 'This app is completely safe and developed by EmpleaWorks.',
        'instant_notifications': 'Instant Notifications',
        'instant_notifications_desc': 'Receive alerts for new offers that match your profile',
        'secure_app': 'Secure Application',
        'secure_app_desc': 'Data protected with end-to-end encryption',
        'optimized_experience': 'Optimized Experience',
        'optimized_experience_desc': 'Interface designed specifically for mobile devices',
        'ready_find_job': 'Ready to find your next job?',
        'join_thousands_users': 'Join thousands of users who are already using EmpleaWorks to find the best job opportunities on their mobile device.',
    ...
    es: {
        ...
        'mobile_app_subtitle': 'Lleva tu búsqueda de empleo contigo. Accede a miles de ofertas laborales, aplica en tiempo real y recibe notificaciones de oportunidades que coincidan con tu perfil.',
        'download_for_android': 'Descarga para Android',
        'version_free': 'Versión 1.0.0 • Gratis',
        'download_apk': 'Descargar APK (74.5 MB)',
        'or': 'o',
        'show_qr_code': 'Mostrar Código QR',
        'hide_qr_code': 'Ocultar Código QR',
        'scan_with_android': 'Escanea con tu dispositivo Android',
        'point_camera_qr': 'Apunta la cámara al código QR para descargar directamente',
        'important_enable_unknown_sources': '⚠️ Importante: Habilitar fuentes desconocidas',
        'install_app_instructions': 'Para instalar esta aplicación desde fuera de Google Play Store, necesitas:',
        'step_1_settings': 'Ir a Configuración de tu dispositivo',
        'step_2_security': 'Buscar Seguridad o Privacidad',
        'step_3_enable': 'Activar Fuentes desconocidas o Instalar apps desconocidas',
        'step_4_browser': 'Permitir la instalación desde el navegador',
        'app_safe_notice': 'Esta app es completamente segura y desarrollada por EmpleaWorks.',
        'instant_notifications': 'Notificaciones Instantáneas',
        'instant_notifications_desc': 'Recibe alertas de nuevas ofertas que coincidan con tu perfil',
        'secure_app': 'Aplicación Segura',
        'secure_app_desc': 'Datos protegidos con encriptación de extremo a extremo',
        'optimized_experience': 'Experiencia Optimizada',
        'optimized_experience_desc': 'Interfaz diseñada específicamente para dispositivos móviles',
        'ready_find_job': '¿Listo para encontrar tu próximo empleo?',
        'join_thousands_users': 'Únete a miles de usuarios que ya están utilizando EmpleaWorks para encontrar las mejores oportunidades laborales en su dispositivo móvil.',
