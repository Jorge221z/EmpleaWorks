...
export default function Register() {
  ...
  // Configuración para el componente Vortex
    ...
    <>
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center p-4">
        <div className="w-full max-w-md space-y-6">
          ...
          <form
            onSubmit={submit}
            className="space-y-6 bg-white dark:bg-gray-900/80 rounded-xl border border-purple-100 dark:border-purple-600/30 p-6 shadow-sm backdrop-blur-sm"
          >
            <div className="space-y-4">
              {/* Name Field */}
              <div className="space-y-2">
                <Label htmlFor="name" className="text-[#9645f4] dark:text-[#c79dff]">
                  {t("name")}
                </Label>
                <Input
                  id="name"
              ...
              {/* Email Field */}
              <div className="space-y-2">
                <Label htmlFor="email" className="text-[#9645f4] dark:text-[#c79dff]">
                  {t("email")}
                </Label>
                <Input
                  id="email"
              ...
              {/* Role Selection */}
              <div className="space-y-2">
                <Label htmlFor="role" className="text-[#9645f4] dark:text-[#c79dff]">
                  {t("role")}
                </Label>
                <Select
                  name="role"
              ...
              <div className="space-y-2">
                <Label htmlFor="password_confirmation" className="text-[#9645f4] dark:text-[#c79dff]">
                  {t("confirm_password")}
                </Label>
                <Input
