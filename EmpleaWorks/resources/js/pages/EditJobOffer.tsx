...
export default function EditJobOffer({ offer, categories = [], contractTypes = [], company }: EditJobOfferProps) {
  ...
  const [date, setDate] = useState<Date | undefined>(offer.closing_date ? new Date(offer.closing_date) : undefined)
      ...
      <div className="relative flex h-full flex-1 flex-col gap-4 rounded-xl p-4 overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="px-2 mb-4">
            <h2 className="text-2xl font-semibold mb-2 text-[#7c28eb] dark:text-purple-300">{t("edit_job_listing")}</h2>
          ...
          >
            <CardHeader className={cn(bgAccentColor, "px-6 py-4")}>
              ...
              <CardDescription className="dark:text-gray-300">{t("update_job_details")}</CardDescription>
            </CardHeader>
