                                        ...
                                        <div className="flex-1">
                                            ...
                                            <section id="gestion-de-cookies" className="mt-8">
                                                ...
                                                <div className="mt-4 grid grid-cols-2 md:grid-cols-4 gap-3">
                                                    ...
                                                    <a href="https://support.mozilla.org/es/kb/Borrar%20cookies" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center p-3 rounded-lg border border-border hover:bg-muted transition-colors text-center">
